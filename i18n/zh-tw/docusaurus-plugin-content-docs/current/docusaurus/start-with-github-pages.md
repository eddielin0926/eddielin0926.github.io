---
id: start-with-github-pages
title: Start with GitHub Pages
sidebar_position: 1
description: Build a website by Docusaurus and deploy on GitHub Pages
keywords:
  - Docusaurus
  - Github Pages
last_update:
...
```js title="docusaurus.config.js.js"
const config = {
  ...
